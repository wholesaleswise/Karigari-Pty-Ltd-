  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      if (values.paymentMethod === "stripe") {
        ...
        formik.setFieldTouched("amountPaid", true);
        formik.setFieldTouched("paidAt", true);
        formik.setFieldTouched("paymentScreenshot", true);
                ...
                <form className="mt-5">
                  ...
                  <div className="grid gap-6">
                    ...
                    <div className="relative">
                      ...
                      >
                        <img
                          className="w-8 md:w-14 h-8 md:h-12 object-contain"
                          src="/qr.png"
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 ">
                      ...
                      {formik.values.paymentMethod === "qr" && (
                        <>
                          ...
                          <div>
                            <div className="relative w-full">
                              <Label className="mt-2 mb-1 text-sm font-medium flex gap-2">
                                Transaction ID
                                <p className="text-red-500">*</p>
                              </Label>
                              <Input
                          ...
                          <div className="mt-4">
                            ...
                            {formik.values.paymentScreenshot instanceof File ? (
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="mt-1 text-xs text-gray-500 ">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="underline text-gray-600 hover:text-blue-500"
                      >
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 w-[90%] max-w-sm relative animate-fadeIn">
            ...
            <div className="flex flex-col items-center space-y-3">
              <img
                src="/qr.png"
                alt="QR Payment"
                className="w-52 h-52 object-contain rounded-md border border-gray-200"
              />
              <p className="text-sm text-gray-600 text-center">
                Scan the QR code to make your payment securely.
              </p>
              <button
                onClick={() => setQrModalOpen(false)}
