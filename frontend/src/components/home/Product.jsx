    ...
    return (
      <div className="container mx-auto px-4 mt-8 relative flex items-center gap-4 md:gap-6 overflow-x-scroll scrollbar-none transition-al">
        {loadingList.map((product, index) => (
          ...
          >
            <div className="bg-primary h-40 p-4 min-w-[180px] md:min-w-[235px] flex justify-center items-center animate-pulse"></div>
            <div className="p-4 grid gap-3">
              <h2 className="font-medium text-base md:text-lg text-ellipsis line-clamp-1 text-black p-1 py-2 animate-pulse rounded-full bg-primary"></h2>
              <p className="capitalize text-primary p-1 animate-pulse rounded-full bg-primary py-2"></p>
              <div className="flex gap-3">
                <p className="text-primary font-medium p-1 animate-pulse rounded-full bg-primary w-full py-2"></p>
                <p className="text-primary line-through p-1 animate-pulse rounded-full bg-primary w-full py-2"></p>
              </div>
              <button className="text-sm text-white px-3 rounded-full bg-primary py-2 animate-pulse"></button>
            </div>
          </div>
        ))}
      </div>
